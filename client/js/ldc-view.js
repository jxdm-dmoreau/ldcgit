...
function ldc_load_completed() {
    ldc_view_init_operations();
    ldc_view_init_categories();
    $("#log").empty();
    $("#main").show();
}
 ...
 * OPERATIONS
******************************************************************************/
function ldc_view_init_operations() {
  ...
  /* Actions on operations */ 
    function view_init_actions() {
        $("div#operations button.add").click(function() {
                var op = { from:1, to:1, date:'2010-01-01', confirm:1, cats: { id:1, value:12}};
                ldc_op_add(op);
        });
...
/******************************************************************************
  * CATEGORIES
******************************************************************************/
function ldc_view_init_categories() {
